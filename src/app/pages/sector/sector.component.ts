    ...
    template: `<div class="card">
            ...
            >
                ...
                <ng-template #body let-macro_sector>
                    <tr>
                        <td>
                            <button pButton icon="pi pi-pencil" class="p-button-rounded p-button-text" [routerLink]="['/configuracion-institucional/sectores/editar', macro_sector.id]" pTooltip="Editar" tooltipPosition="top"></button>
                        ...
                        <td>{{ macro_sector.nombreMacroSector }}</td>
                        <td>
